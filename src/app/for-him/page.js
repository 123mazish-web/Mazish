...
export default function ForHimPage() {
  ...
  // Explicit Him Selection by Name (Robust against DB vs Fallback IDs)
  const himNames = [
    "MAZISH Classic Aviator",
    "MAZISH Onyx Shadow",
    "MAZISH Lumina Rose",
    "MAZISH Mirage Silver",
    "MAZISH Elysian Amber"
  ]
  const menProducts = products.filter(p => himNames.includes(p.name))
    ...
    <div className="bg-warm-bg min-h-screen py-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="font-luxury text-[34px] sm:text-[42px] text-charcoal tracking-wider uppercase">FOR HIM</h1>
          <p className="text-secondary-text text-[16px] max-w-md mx-auto leading-relaxed">
            Bold lines, polarized lenses, and engineered comfort for the modern man.
          </p>
